...
public class Player extends Actor {
	...
	private String getRankColour() {
		if (titleString == null) {
			return "";
		} else if (titleString.equals("Easy")) {
			return "2AF214";
		} else if (titleString.equals("Normal")) {
			return "087F88";
		} else if (titleString.equals("Hard")) {
			return "FF930D";
		} else if (titleString.equals("Legend")) {
			return "B00A0A";
		} else if (titleString.equals("Elite")) {
			return "FF0000";
		} else {
			return "";
		}
